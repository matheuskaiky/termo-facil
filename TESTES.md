...
**Estado atual:** 148 testes de backend passando (`--cov=app`).
...
└── tests/
    ...
    ├── api/                    # auth, admin, delegacias, users_admin, descarte, audio, jobs, processos, metricas, pdf, termos, upload, idor
