...
**Estado atual:** 160 testes de backend passando em modo `mock` (`--cov=app`).
...
└── tests/
    ...
    ├── api/                    # auth, admin, admin_immutable, delegacias, users_admin, descarte, signed_lock, reprocess_speakers, audio, jobs, processos, metricas, pdf, termos, upload, idor
